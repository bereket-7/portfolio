  ...
  const experiences = [
    {
      ...
      period: "2023 - Present",
      description:
        "Led development of enterprise web applications using Spring boot, React, NestJs and Django.",
      achievements: [
        ...
        "Led a team of 3 developers to deliver projects on time and within budget",
      ],
    },
    {
      company: "Melfan Tech",
  ...
  const education = [
    {
      ...
      period: "2018 - 2023",
      description:
        "Specialized in web technologies and distributed systems. Completed thesis on scalable web architecture patterns.",
    },
  ];
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-200 leading-relaxed">
              ...
              web applications. Passionate about creating elegant solutions to
              complex problems.
            </p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 mb-20">
            ...
            >
              ...
              <div className="space-y-6 text-secondary-700">
                <p>
                  Hello! I'm Bereket, a full stack developer with a passion for
                  building exceptional digital experiences. My journey in web
                  development began over 5 years ago, and since then, I've had
                  the privilege of working with a diverse range of clients and
                  technologies.
                </p>
                <p>
                ...
                <p>
                  ...
                  my knowledge through tech communities and mentorship programs.
                </p>
              </div>
