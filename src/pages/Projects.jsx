...
function Projects() {
  ...
  const allProjects = [
    ...
    },
    {
      ...
      description: "Interactive weather forecasting application with location detection and historical data visualization.",
    ...
    },
    {
      ...
      description: "Data visualization dashboard for social media metrics and engagement analysis.",
    ...
    },
    {
      ...
      description: "Reservation management system for restaurants with online booking and table management.",
    ...
    },
    {
      ...
      description: "Financial application for monitoring stock investments, performance, and market trends.",
    ...
    },
    {
      ...
      description: "Custom video streaming service with user accounts, playlists, and content management.",
      ...
      <div className="container mx-auto px-4 md:px-6 py-16">
        ...
        {filteredProjects.length === 0 && (
          <div className="text-center py-12">
            ...
            <h3 className="mt-2 text-sm font-medium text-secondary-900">No projects found</h3>
            <p className="mt-1 text-sm text-secondary-500">No projects match the selected category.</p>
            <div className="mt-6">
              <button
        ...
        <div className="mt-16 bg-secondary-100 rounded-lg p-8 text-center">
          <h2 className="text-2xl md:text-3xl font-bold text-secondary-900 mb-4">Have a project in mind?</h2>
          <p className="text-secondary-600 mb-6 max-w-2xl mx-auto">
            I'm always looking for interesting projects to work on. Let's discuss your ideas and create something amazing together.
          </p>
          <a
            href="/contact"
