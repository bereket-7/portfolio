      ...
      <div className="container mx-auto px-4 md:px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="mt-4 text-gray-400 max-w-xs">
              Full stack developer focused on creating clean, user-friendly experiences that solve real business problems.
            </p>
            ...
            <ul className="space-y-3">
              {isHomePage ? (
                ...
                <>
                  ...
                  <li>
                    <Link to="/projects" className="text-gray-400 hover:text-primary-400 transition">
                      Projects
                    </Link>
                  </li>
                  <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                <svg className="w-5 h-5 text-primary-400 mr-2 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <a href="mailto:bereket@example.com" className="text-gray-400 hover:text-primary-400 transition">
                  bereket@example.com
                </a>
              </li>
              <li className="flex items-start">
        ...
        <div className="mt-12 pt-8 border-t border-secondary-800 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="mt-4 md:mt-0 flex flex-wrap gap-4">
            <a href="#" className="text-sm text-gray-400 hover:text-primary-400 transition">
              Privacy Policy
            </a>
            <a href="#" className="text-sm text-gray-400 hover:text-primary-400 transition">
              Terms of Service
