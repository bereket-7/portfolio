    ...
    <div>
      <div className="text-center mb-12">
        ...
        <p className="text-lg text-gray-300 max-w-3xl mx-auto">
          ...
          hear from you! Send me a message and I'll get back to you soon.
        </p>
      </div>
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-start">
              ...
              <div className="ml-4">
                ...
                <p className="text-gray-400">+251934160075</p>
              </div>
            </div>
          ...
          <div className="mt-8">
            ...
            <div className="flex space-x-4">
              <a
                ...
                className="w-10 h-10 rounded-full flex items-center justify-center bg-secondary-700 text-white hover:bg-primary-600 transition"
              >
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
