      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -right-6 w-32 h-32 bg-white p-2 rounded-lg shadow-lg">
              <div className="w-full h-full bg-primary-600 rounded-md flex flex-col items-center justify-center text-white">
                ...
                <span className="text-xs font-medium">Years of<br />Experience</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <p className="text-secondary-700 mb-6">
            ...
            My passion is creating beautiful, intuitive interfaces backed by robust, scalable backend systems.
            With 5+ years of experience in the field, I've worked with a diverse range of clients from startups to
          ...
          <p className="text-secondary-700 mb-8">
            ...
            but I'm always eager to learn new skills and technologies to deliver the best solutions for my clients.
            My approach focuses on writing clean, maintainable code that solves real business problems.
          </p>
